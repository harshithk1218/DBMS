...
/*	USER()	Host_Name	MySQL_Version	Current_Date_Time
	root@localhost	RVU-PC-032	8.4.6	2025-09-01 12:30:54
*/
...
(003, 'Harshith', 2024-09-12),
(004, 'Mohan', 2024-03-15),
(005, 'Harsha', 2024-06-07);
SELECT * FROM Members;
